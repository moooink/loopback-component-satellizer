...
module.exports = function(options) {
  var Common, Model, credentials, fetchAccessToken, fetchProfile, link, version;
  version = options.facebook.version ? options.facebook.version : 'v2.3';
  ...
  fetchAccessToken = function(code, clientId, redirectUri, callback) {
    ...
    if (((ref = options.facebook.fields) != null ? ref.length : void 0) > 0) {
